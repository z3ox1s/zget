try:
    ...
    # Main function
    def postMethod(target, payloadF = '', payloadH = '', payloadC = '', payloadU = '', payloadRH = '', filename = ''):
        payload_F = dict()
        payload_H = dict()
        payload_C = dict()
        ...
        if filename:
            ...
            response = post(target, data = payload_F, headers = payload_H, cookies = payload_C, allow_redirects = True)
